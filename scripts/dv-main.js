...
async function main() {
  ...
  try {
    ...
    const header = `// Auto-generated ABI. Updated by dv-main.js on ${new Date().toISOString()}\n`;
    ...
    const wlHeader = `// Auto-generated WhitelistManager ABI. Updated by dv-main.js on ${new Date().toISOString()}\n`;
    ...
    const invusdHeader = `// Auto-generated InvUsdToken ABI. Updated by dv-main.js on ${new Date().toISOString()}\n`;
